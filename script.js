...
const quizData = [
  ...
  },
  {
    ...
    correctAnswer: "X",
    explanation: "<b>고객만족도 지수와 고객 VoC</b>는 특정 조직만의 지표가 아니라 <b>모든 구성원이 함께 <br>활용해야 할 실행 기준</b>입니다. 고객과 중장기 파트너십 구축을 위해 고객만족도 지수를<br> 지속 모니터링하며 정기적으로 VoC를 수집하고 있습니다."
  },
  {
    id: 3,
    question: "프로젝트가 종료되면 고객 대응도 마무리되므로, <br>추가적인 제안이나 후속 고민은 꼭 진행할 필요는 없다.",
    correctAnswer: "X",
    explanation: "프로젝트 수행 중 발견한 고객 Painpoint에 기반하여, 이를 <b>Reflection Memo로 작성</b>하며<br>우리가 제공한 서비스를 돌아보고 프로젝트를 보완/강화하기 위한 추가 제안을 고민합니다.<br> 이러한 <b>후제안 활동</b>은 우리만의 경쟁력이자 고객 중심 업무 프로세스입니다."
  },
  {
    id: 4,
    question: "고객 관련 의사결정은 경험과 직관도 중요하므로, <br>VoC나 행동 데이터 분석까지는 반드시 확인하지 않아도 된다.",
    correctAnswer: "X",
    explanation: "우리의 크고 작은 결정 뒤에는 고객의 생생한 데이터가 있습니다. <b>고객 Painpoint가 담긴<br>VoC</b>부터 <b>행동 데이터</b>까지, 고객과 관련된 모든 정보를 분석합니다.<br>현장에서 쌓은 우리의 경험에 더해 고객 데이터를 함께 고려할 때,<br>고객에게 더 나은 경험을 제공할 수 있습니다."
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: "X",
    explanation: "고객만족도 조사 결과는 KI 커미티를 통해 경영진과 리더들에게 공유되며, 이후 구성원에까지<br>모두 공유되고 있어요. <b>고객의 소리(VoC)</b>는 <b>구성원 모두의 업무 나침반</b>입니다. <br>공유된 고객만족도 결과 속에서 우리 팀, 또는 나의 업무와 연결되는 피드백을 찾아<br>실제 개선으로 이어가 보세요."
  },
  {
    id: 9,
    question: "새로운 고객 경험을 제공할 수 있는 아이디어는 <br>담당 직무와 관련된 영역에서만 제안할 수 있다.",
    correctAnswer: "X",
    explanation: "고객 경험 혁신에는 경계가 없습니다. <br><b>고객을 위한 아이디어라면 누구나 자유롭게</b> 사업부 리더들이나 고객가치혁심팀에게 제안해주세요."
  },
  {
    id: 10,
