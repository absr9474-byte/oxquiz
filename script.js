...
const quizData = [
  ...
  },
  {
    ...
    correctAnswer: "X",
    explanation: "고객이 요청하지 않았더라도 Reflection Memo를 작성하며 <br>남아있는 Pain Point와 숨겨진 니즈를 고민하고 선제적으로 제안하는 ‘후제안’ 활동은 <br>우리가 고객가치 중심으로 일하는 업무 프로세스입니다."
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: "X",
    explanation: "고객만족도 조사 결과는 KI 커미티를 통해 공유되며, 이후 구성원에까지 모두 투명하게 <br>공유되고 있어요. 고객의 목소리는 전사 구성원 모두의 업무 나침반입니다. <br>공유된 고객만족도 결과 속에서 우리 팀, 또는 나의 업무와 연결되는 피드백을 <br>찾아 실제 개선으로 이어가 보세요."
  },
  {
    id: 9,
