...
const quizData = [
  {
    ...
    correctAnswer: "O",
    explanation: "우리 회사는 경영진이 제시하는 고객가치 지향점이 <br>각 부서와 개인 성과목표에 자연스럽게 녹아들 수 있도록, <br><b>매년 고객가치혁신 목표를 수립</b>하고 있습니다."
  },
  {
    id: 2,
    question: "고객만족도 지수(CSI)와 고객 VoC는 영업 조직에서 관리하는 지표이므로, <br>내 업무 개선과는 직접적인 관련이 없다.",
    correctAnswer: "X",
    explanation: "<b>고객만족도 지수와 고객의 소리</b>는 특정 조직만의 지표가 아니라 <b>모든 구성원이 함께 <br>활용해야 할 실행 기준</b>입니다. 고객과의 중장기 파트너십 구축을 위해 <br>고객만족도 지수(CSI)를 관리하며 정기적으로 고객 VoC 수집 및 모니터링하고 있습니다."
  },
  {
    id: 3,
    question: "프로젝트가 종료되면 고객 대응도 마무리되므로, <br>추가적인 제안이나 후속 고민은 꼭 진행할 필요는 없다.",
    correctAnswer: "X",
    explanation: "프로젝트 종료 후, <b>Reflection Memo를 작성</b>하며 우리가 제공한 서비스를 돌아보고,<br>프로젝트를 보완/강화하기 위한 추가 제안을 고민합니다.<br> 이러한 <b>후제안 활동</b>은 우리만의 고객 중심 업무 프로세스입니다."
  },
  {
    id: 4,
    question: "고객 관련 의사결정은 경험과 직관도 중요하므로, <br>VoC나 행동 데이터 분석까지는 반드시 확인하지 않아도 된다.",
    correctAnswer: "X",
    explanation: "우리의 크고 작은 결정 뒤에는 고객의 생생한 데이터가 있습니다. <br><b>고객 Painpoint가 담긴 VoC</b>부터 <b>행동 데이터</b>까지, 고객과 관련된 모든 정보를 분석합니다. <br>이렇게 축적된 데이터는 사업 전략 수립과 서비스 개선을 위한 <br>객관적이고 중요한 판단 기준으로 활용되고 있습니다."
  },
  {
    id: 5,
    question: "고객 문제 해결에 활용할 수 있는 우리만의 AI Tool을 <br>자율적으로 활용하고 서로 공유하며 AI활용 역량을 강화하고 있습니다.",
    correctAnswer: "O",
    explanation: "고객 데이터를 기반으로 신속하고 정교한 솔루션을 도출할 수 있는 <br><b>Brand Agent</b>와 <b>Survey Agent</b>, 업무효율을 극대화하는 <b>Deep Agent Builder</b> 등 <br>우리만의 AI Tool이 마련되어 있습니다. 모든 구성원이 AI Tool을 잘 활용할 수 있도록 <br>워크샵과 교육 프로그램도 병행하고 있습니다."
  },
  {
    id: 6,
    question: "고객이 AE를 통해 직접 전달한 의견만 확인해도 충분하며, <br>비정기적으로 다양한 채널에서의 VoC를 수집하며 인사이트를 도출하고 있습니다.",
    correctAnswer: "X",
    explanation: "AE가 현장에서 상시 수집하는 접점 데이터는 물론, 담당자에게 직접 전하기 어려운 <br>불편 사항까지 배려하여 전사 차원의 <b>정기 고객만족도 조사</b>를 시행하고 있어요. <br>다양한 채널을 통해 고객 데이터를 수집하며 우리가 제공하는 마케팅 서비스에 대한 <br>고객의 기대와 만족도를 촘촘하게 모니터링합니다."
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: "X",
    explanation: "고객만족도 조사 결과는 KI 커미티를 통해 공유되며, 이후 구성원에까지 모두 투명하게 <br>공유되고 있어요. <b>고객의 목소리</b>는 <b>구성원 모두의 업무 나침반</b>입니다. <br>공유된 고객만족도 결과 속에서 우리 팀, 또는 나의 업무와 연결되는 피드백을 찾아<br>실제 개선으로 이어가 보세요."
  },
  {
    id: 9,
    question: "새로운 고객 경험을 제공할 수 있는 아이디어는 <br>담당 직무와 관련된 영역에서만 제안할 수 있다.",
    correctAnswer: "X",
    explanation: "고객 경험 혁신에는 직무의 경계가 없습니다. <br>담당 업무와 무관하더라도 <b>고객을 위한 아이디어라면 누구나 자유롭게 제안</b>할 수 있습니다."
  },
  {
    id: 10,
    question: "우리는 고객 중심으로 조직과 역량을 연결하고 고객의 중장기 사업 성공까지 <br>함께 고민하는 든든한 파트너로서 고객과 함께 성장하고 있다.",
    correctAnswer: "O",
    explanation: "LG전자 등 <b>핵심 고객을 중심</b>으로 <b>필요한 기능과 전문 역량을 통합적으로 연결</b>하고, <br>신속•맞춤형으로 대응하기 위해 노력하고 있습니다."
  }
];
